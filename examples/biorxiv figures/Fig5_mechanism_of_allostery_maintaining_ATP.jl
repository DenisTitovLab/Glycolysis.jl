...
glycolysis_params_copy_affect2.ATPase_Vmax = Initial_ATPase_Vmax_frac *
                                             2 *
...
ax_pi_trap, im = image(fig[1, 1:3], rotr90(pi_trap), axis = (aspect = DataAspect(),))
...
axislegend(
    ...
    ["Metabolites before GAPDH", "Metabolites after GAPDH", "ATP", "ADP", "Phosphate"],
    position = :lb,
    # position = (1.075, 1.05),
    rowgap = 1,
    framevisible = false,
