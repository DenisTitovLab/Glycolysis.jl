...
#=
Running this code take ~3 min on 8 core computer.
=#
...
text!(
    ax_ATP_conc,
    0.0,
    1.0 * (glycolysis_init_conc.ATP + glycolysis_init_conc.ADP + glycolysis_init_conc.AMP),
    text="Adenine pool size",
    align=(:left, :bottom),
    color=:grey,
)
...
save("Results/$(Dates.format(now(),"mmddyy"))_Fig6_suppl_fig1_gsa_and_sims_for_cofactor_pool_sizes_and_AK_CK_NDPK.png", fig, px_per_unit = 4)
