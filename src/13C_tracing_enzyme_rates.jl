function rate_13C_GLUT(metabs, params)
...
function rate_13C_HK1(metabs, params)
    Glucose = metabs.Glucose_12C + metabs.Glucose_13C
    ...
    Z = (
        (
            ...
            (params.HK1_β_Glucose_ATP) * (Glucose / params.HK1_K_Glucose) * (metabs.ATP / params.HK1_K_a_ATP) +
...
function rate_13C_GPI(metabs, params)
    G6P = metabs.G6P_12C + metabs.G6P_13C
    F6P = metabs.F6P_12C + metabs.F6P_13C

    Rate = (
        (params.GPI_Vmax * params.GPI_Conc / params.GPI_Km_G6P) * (metabs.G6P_13C - (1 / params.GPI_Keq) * metabs.F6P_13C) /
        (1 + G6P / params.GPI_Km_G6P + F6P / params.GPI_Km_F6P)
    )
    return Rate
end

function rate_13C_PFKP(metabs, params)
    F6P = metabs.F6P_12C + metabs.F6P_13C
    ...
    Rate =
        params.PFKP_Vmax *
        params.PFKP_Conc *
        (metabs.ATP * metabs.F6P_13C - metabs.ADP * metabs.F16BP_13C / params.PFKP_Keq) *
...
function rate_13C_ALDO(metabs, params)
    F16BP = metabs.F16BP_12C + metabs.F16BP_13C
...
function rate_13C_TPI(metabs, params)
    GAP = metabs.GAP_12C + metabs.GAP_13C
    DHAP = metabs.DHAP_12C + metabs.DHAP_13C
...
function rate_13C_GAPDH(metabs, params)
    GAP = metabs.GAP_12C + metabs.GAP_13C
    ...
    Rate = (
        ...
        Z_a^3 *
        (metabs.GAP_13C * metabs.NAD * metabs.Phosphate - (1 / params.GAPDH_Keq) * metabs.BPG_13C * metabs.NADH) /
        (Z_a^4 + params.GAPDH_L * Z_i^4)
    )
    return Rate
end

function rate_13C_PGK(metabs, params)
    BPG = metabs.BPG_12C + metabs.BPG_13C
...
function rate_13C_PGM(metabs, params)
    ThreePG = metabs.ThreePG_12C + metabs.ThreePG_13C
...
function rate_13C_ENO(metabs, params)
    TwoPG = metabs.TwoPG_12C + metabs.TwoPG_13C
...
function rate_13C_PKM2(metabs, params)
    PEP = metabs.PEP_12C + metabs.PEP_13C
...
function rate_13C_LDH(metabs, params)
    Pyruvate = metabs.Pyruvate_12C + metabs.Pyruvate_13C
...
function rate_13C_MCT(metabs, params)
    Lactate = metabs.Lactate_12C + metabs.Lactate_13C
